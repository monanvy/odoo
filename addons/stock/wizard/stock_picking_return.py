...
class ReturnPicking(models.TransientModel):
    ...
    def _create_returns(self):
        ...
        for return_line in self.product_return_moves:
            ...
            if new_qty:
                ...
                returned_lines += 1
                return_line.move_id.copy(self._prepare_return_move_vals(return_line, new_qty, new_picking, picking_type_id, picking, move_dest_id))
    ...
    # Start Trobz Change
    @api.multi
    def _prepare_return_move_vals(self, return_line, new_qty, new_picking, picking_type_id, picking, move_dest_id):
        return {
