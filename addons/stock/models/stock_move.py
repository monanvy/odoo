    ...
    def action_assign(self, no_prepare=False):
        ...
        for move in moves:
            ...
            if move.product_id.type == 'consu' and not ancestors:
                ...
                # [FIXME] Allow reserve quants without history condition
...
#                     main_domain[move.id] += [('history_ids', 'in', move.origin_returned_move_id.id)]
    ...
    def _move_quants_by_lot_v10(self, quants_taken, false_quants, pack_operation, lot_quantities, lot_move_quantities, dest_package_id):
        ...
        # [FIX] Fix for case Force qty when product track by lots
        ...
        for move_rec_updateme in self:
            ...
            # FIXME: Need to check whether quant still exist or has been deleted
            # due to action reconcile
            false_quants = [quant for quant in false_quants if quant.exists()]
